...
ActiveRecord::Schema.define(version: 20150415144921) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.string   "contact_num", limit: 255
  ...
  create_table "campaigns", force: :cascade do |t|
    ...
    t.integer  "email_limit",       limit: 4
    t.integer  "email_used",        limit: 4
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
  ...
  add_index "campaigns", ["email_list_id"], name: "index_campaigns_on_email_list_id", using: :btree
  ...
  create_table "emailids", force: :cascade do |t|
    t.integer  "email_list_id", limit: 4
    t.string   "email",         limit: 255
    t.integer  "unsubscribe",   limit: 4
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
  end

  add_index "emailids", ["email_list_id"], name: "fk_rails_94acf82889", using: :btree
